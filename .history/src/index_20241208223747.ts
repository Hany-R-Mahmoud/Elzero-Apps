...
let navbarLogoTranslation = navbarNav.childElementCount - 70;
window.addEventListener("scroll", () => {
  ...
  if (navbarToggleBtn.getAttribute("aria-expanded") === "true") {
    ...
    navbarLogo.style.set = "logo-up-down 5s ease-in-out infinite alternate";
...
console.log("--translate-y", navbarProgressHeight + "px");
/* Start Up button */
