      ...
      eventsList.innerHTML += `
                <li class="added-event col-lg-4 col-md-6 mb-2">
                    <div class="event-box card p-3 border-0 ">
                      <h3>${newEvent.name.toUpperCase()}</h3>
                      <p class="d-flex justify-content-between">Organizer<span>${newEvent.organizer.toUpperCase()}</span> </p>
                      <p class="d-flex justify-content-between">Date<span>${
                        newEvent.date
                      }</span></p>
