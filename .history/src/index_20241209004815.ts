...
let pwLettersPool = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789#$%^&*()-_=+[]|;:,<.>?`;

const pwLength = (<HTMLInputElement>document.querySelector(".pw-length")).value;
...
const spCharCheckbox = <HTMLInputElement>document.querySelector("#opt-number");
