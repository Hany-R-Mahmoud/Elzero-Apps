...
console.log(navbarNav.childElementCount);
...
console.log(`(90 + (${navbarNav.childElementCount} * 40))px`);
window.addEventListener("scroll", () => {
  let scrollTop = document.documentElement.scrollTop;
  navbarProgress.style.width = `${(scrollTop / height) * 100}%`;
  if (navbarToggleBtn.getAttribute("aria-expanded") === "true") {
    navbarProgress.style.height = `(90 + (${navbarNav.childElementCount} * 40))px`;
...
console.log(90 + navbarNav.childElementCount * 40);
