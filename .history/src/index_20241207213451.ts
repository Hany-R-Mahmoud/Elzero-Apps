...
allChosenCtgryNames.forEach((item) => {
  item.addEventListener("click", () => {
    ...
    //   item.innerHTML;
    console.log(document.querySelector(".bookmark-category"));
  });
});

console.log(document.querySelector(".bookmark-category"));
console.log(document.querySelector(".bookmark-category").value);
// console.log(document.querySelector(".chosen-category-name"));
// console.log(document.querySelector(".chosen-category-name").innerHTML);
