  ...
  allEvents.forEach((newEvent) => {
    eventsList.innerHTML += `
        <li class="added-event col-lg-4 col-md-6 mb-2">
            <div class="event-box card p-3 border-0 flex-start">
              <h3>${newEvent.name}</h3>
              <p class="d-flex justify-content-between"><span>By:</span> ${newEvent.organizer}</p>
              ...
              <button class="btn rounded btn-danger">Delete</button>
            </div>
          </li>
        `;
  });
