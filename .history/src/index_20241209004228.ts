...
const pwLengthInput = <HTMLInputElement>document.querySelector(".pw-length");
...
pwGenerateBtn.addEventListener("click", () => {
  console.log(pwLengthInput.value);
...
let pwPool = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789#$%^&*()-_=+[]|;:,<.>?
`;
console.log(...pwPool);
// console.log(pwPool.match(/[a-z]/gi));
console.log(pwPool.match(/\W/gi));
