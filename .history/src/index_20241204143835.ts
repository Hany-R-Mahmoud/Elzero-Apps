      ...
      eventsList.innerHTML += `
                <li class="added-event col-lg-4 col-md-6 mb-2">
                    <div class="event-box card p-3 border-0 ">
                      <h3>${newEvent.name}</h3>
                      <p class="d-flex justify-content-between">Organizer<span>${newEvent.organizer}</span> </p>
                ...
                `;
      if (timeLeft < 360000000000) {
        (document.querySelector(".time-left") as HTMLSpanElement).style.color =
          "#e84a5f";
      }
    }
  );
