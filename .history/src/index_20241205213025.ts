...
const allChosenCtgryTabs =<NodeListOf<HTMLLIElement>>document.querySelectorAll(".chosen-category-tab")
const allBkmrkItems =<NodeListOf<HTMLLIElement>>document.querySelectorAll(".bookmark-item")
  ...
  (bkmrkList.innerHTML = ""),
    allBookmarks.forEach(
      (
        ...
        bkmrkList.innerHTML += `
        <li
                  class="bookmark-item d-flex px-3 py-2 align-items-center justify-content-between rounded mb-2"
                >
...
allChosenCtgryTabs.forEach((tab) => {
    tab.addEventListener("click", (e) => {
        ...
        document.querySelectorAll(e.currentTarget.dataset.).forEach((item) => {
